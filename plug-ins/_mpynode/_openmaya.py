...
class MVector(om.MVector):
    """
    3D vector with double-precision coordinates. Overrides OpenMaya.MVector to add custom functionality
    """
...
class MVectorArray(om.MVectorArray):
    ...
    it will return version of OpenMaya.MVectorArray as a result. 
    """
