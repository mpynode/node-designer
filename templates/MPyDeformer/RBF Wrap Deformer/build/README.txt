MPyNode compiled plugin: MPyDeformer_RBF_Wrap_Deformer
======================================================
...
What you'll see
---------------
  ../MPyDeformer_RBF_Wrap_Deformer.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/rbfWrapDeformer.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyDeformer_RBF_Wrap_Deformer.bundle
