...
# Edit source/nurbsWave.cpp, then run ./build.sh to produce MPyDeformer_NURBS_Wave.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyDeformer_NURBS_Wave.bundle" "$HERE/source/nurbsWave.cpp"
echo "Built: $HERE/../MPyDeformer_NURBS_Wave.bundle"
lipo -info "$HERE/../MPyDeformer_NURBS_Wave.bundle"
