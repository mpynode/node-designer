MPyNode compiled plugin: MPyDeformer_Patch_Relax
================================================
...
What you'll see
---------------
  ../MPyDeformer_Patch_Relax.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/patchRelax.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyDeformer_Patch_Relax.bundle
