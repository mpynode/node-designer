#!/usr/bin/env bash
# Generated build for native node 'patchRelax'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/patchRelax.bundle" "$HERE/patchRelax.cpp"
echo "Built: $HERE/patchRelax.bundle"
lipo -info "$HERE/patchRelax.bundle"
