#!/usr/bin/env bash
# Generated build for native node 'sineRippleDefault'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/sineRippleDefault.bundle" "$HERE/sineRippleDefault.cpp"
echo "Built: $HERE/sineRippleDefault.bundle"
lipo -info "$HERE/sineRippleDefault.bundle"
