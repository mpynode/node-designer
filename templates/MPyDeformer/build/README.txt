MPyNode compiled plugin: basics_MPyDeformer
===========================================
...
What you'll see
---------------
  ../basics_MPyDeformer.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/sineRippleDefault.cpp   <- the node. Edit this file to change the plugin's behaviour.
