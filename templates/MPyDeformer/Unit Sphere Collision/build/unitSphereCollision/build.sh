#!/usr/bin/env bash
# Generated build for native node 'unitSphereCollision'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -lOpenMaya -lFoundation -lOpenMayaAnim \
  -o "$HERE/unitSphereCollision.bundle" "$HERE/unitSphereCollision.cpp"
echo "Built: $HERE/unitSphereCollision.bundle"
lipo -info "$HERE/unitSphereCollision.bundle"
