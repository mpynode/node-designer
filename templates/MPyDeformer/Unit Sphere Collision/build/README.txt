MPyNode compiled plugin: MPyDeformer_Unit_Sphere_Collision
==========================================================
...
What you'll see
---------------
  ../MPyDeformer_Unit_Sphere_Collision.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/unitSphereCollision.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyDeformer_Unit_Sphere_Collision.bundle
