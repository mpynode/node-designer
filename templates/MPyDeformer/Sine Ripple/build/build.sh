#!/usr/bin/env bash
# Rebuild native plugin 'MPyDeformer_Sine_Ripple' from its single source 'source/sineRipple.cpp'.
# Edit source/sineRipple.cpp, then run ./build.sh to produce MPyDeformer_Sine_Ripple.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyDeformer_Sine_Ripple.bundle" "$HERE/source/sineRipple.cpp"
echo "Built: $HERE/../MPyDeformer_Sine_Ripple.bundle"
lipo -info "$HERE/../MPyDeformer_Sine_Ripple.bundle"
