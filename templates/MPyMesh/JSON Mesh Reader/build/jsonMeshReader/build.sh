#!/usr/bin/env bash
# Generated build for native node 'jsonMeshReader'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/jsonMeshReader.bundle" "$HERE/jsonMeshReader.cpp"
echo "Built: $HERE/jsonMeshReader.bundle"
lipo -info "$HERE/jsonMeshReader.bundle"
