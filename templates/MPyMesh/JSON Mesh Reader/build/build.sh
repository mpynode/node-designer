#!/usr/bin/env bash
# Rebuild native plugin 'MPyMesh_JSON_Mesh_Reader' from its single source 'source/jsonMeshReader.cpp'.
# Edit source/jsonMeshReader.cpp, then run ./build.sh to produce MPyMesh_JSON_Mesh_Reader.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyMesh_JSON_Mesh_Reader.bundle" "$HERE/source/jsonMeshReader.cpp"
echo "Built: $HERE/../MPyMesh_JSON_Mesh_Reader.bundle"
lipo -info "$HERE/../MPyMesh_JSON_Mesh_Reader.bundle"
