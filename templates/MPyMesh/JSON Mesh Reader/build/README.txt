MPyNode compiled plugin: MPyMesh_JSON_Mesh_Reader
=================================================
...
What you'll see
---------------
  ../MPyMesh_JSON_Mesh_Reader.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/jsonMeshReader.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyMesh_JSON_Mesh_Reader.bundle
