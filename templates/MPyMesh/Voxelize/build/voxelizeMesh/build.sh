#!/usr/bin/env bash
# Generated build for native node 'voxelizeMesh'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/voxelizeMesh.bundle" "$HERE/voxelizeMesh.cpp"
echo "Built: $HERE/voxelizeMesh.bundle"
lipo -info "$HERE/voxelizeMesh.bundle"
