MPyNode compiled plugin: MPyMesh_UV_Layout
==========================================
...
What you'll see
---------------
  ../MPyMesh_UV_Layout.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/uvLayoutMesh.cpp   <- the node. Edit this file to change the plugin's behaviour.
