MPyNode compiled plugin: MPyMesh_Mesh_Maze
==========================================
...
What you'll see
---------------
  ../MPyMesh_Mesh_Maze.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/meshMaze.cpp   <- the node. Edit this file to change the plugin's behaviour.
