#!/usr/bin/env bash
# Rebuild native plugin 'MPyMesh_Mesh_Maze' from its single source 'source/meshMaze.cpp'.
# Edit source/meshMaze.cpp, then run ./build.sh to produce MPyMesh_Mesh_Maze.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyMesh_Mesh_Maze.bundle" "$HERE/source/meshMaze.cpp"
echo "Built: $HERE/../MPyMesh_Mesh_Maze.bundle"
lipo -info "$HERE/../MPyMesh_Mesh_Maze.bundle"
