MPyNode compiled plugin: MPyMesh_Game_Of_Life
=============================================
...
What you'll see
---------------
  ../MPyMesh_Game_Of_Life.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/gameOfLifeMesh.cpp   <- the node. Edit this file to change the plugin's behaviour.
