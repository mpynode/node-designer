#!/usr/bin/env bash
# Rebuild native plugin 'MPyMesh_Disk_Mesh_Cache' from its single source 'source/diskMeshCache.cpp'.
# Edit source/diskMeshCache.cpp, then run ./build.sh to produce MPyMesh_Disk_Mesh_Cache.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyMesh_Disk_Mesh_Cache.bundle" "$HERE/source/diskMeshCache.cpp"
echo "Built: $HERE/../MPyMesh_Disk_Mesh_Cache.bundle"
lipo -info "$HERE/../MPyMesh_Disk_Mesh_Cache.bundle"
