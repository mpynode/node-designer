MPyNode compiled plugin: MPyMesh_Disk_Mesh_Cache
================================================
...
What you'll see
---------------
  ../MPyMesh_Disk_Mesh_Cache.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/diskMeshCache.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyMesh_Disk_Mesh_Cache.bundle
