#!/usr/bin/env bash
# Generated build for native node 'linearBlendSkin'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/linearBlendSkin.bundle" "$HERE/linearBlendSkin.cpp"
echo "Built: $HERE/linearBlendSkin.bundle"
lipo -info "$HERE/linearBlendSkin.bundle"
