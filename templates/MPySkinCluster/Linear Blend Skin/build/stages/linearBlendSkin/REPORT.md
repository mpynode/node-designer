...
**Source node:** `linearBlendSkin`  ·  **Base:** `MPxSkinCluster`  ·  **Generated:** 2026-09-08 20:50

| stage | outcome |
|---|---|
| 1 Transpile | deterministic C++, no AI |
| 2 AI assist | not run (nothing to fill) |
| 3 AI optimize | **10.22x** over 2 round(s) -- re-measured: unmeasurable under the gate |
