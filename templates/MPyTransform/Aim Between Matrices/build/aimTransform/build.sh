#!/usr/bin/env bash
# Generated build for native node 'aimTransform'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/aimTransform.bundle" "$HERE/aimTransform.cpp"
echo "Built: $HERE/aimTransform.bundle"
lipo -info "$HERE/aimTransform.bundle"
