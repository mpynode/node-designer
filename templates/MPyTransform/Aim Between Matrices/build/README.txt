MPyNode compiled plugin: MPyTransform_Aim_Between_Matrices
==========================================================
...
What you'll see
---------------
  ../MPyTransform_Aim_Between_Matrices.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/aimTransform.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyTransform_Aim_Between_Matrices.bundle
