#!/usr/bin/env bash
# Generated build for native node 'meshRegionLocator'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/meshRegionLocator.bundle" "$HERE/meshRegionLocator.cpp"
echo "Built: $HERE/meshRegionLocator.bundle"
lipo -info "$HERE/meshRegionLocator.bundle"
