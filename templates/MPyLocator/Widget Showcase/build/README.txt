MPyNode compiled plugin: MPyLocator_Widget_Showcase
===================================================
...
What you'll see
---------------
  ../MPyLocator_Widget_Showcase.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/widgetShowcase.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyLocator_Widget_Showcase.bundle
