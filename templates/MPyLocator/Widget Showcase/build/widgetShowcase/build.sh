#!/usr/bin/env bash
# Generated build for native node 'widgetShowcase'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/widgetShowcase.bundle" "$HERE/widgetShowcase.cpp"
echo "Built: $HERE/widgetShowcase.bundle"
lipo -info "$HERE/widgetShowcase.bundle"
