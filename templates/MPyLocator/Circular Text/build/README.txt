MPyNode compiled plugin: MPyLocator_Circular_Text
=================================================
...
What you'll see
---------------
  ../MPyLocator_Circular_Text.mll   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/circularText.cpp   <- the node. Edit this file to change the plugin's behaviour.
