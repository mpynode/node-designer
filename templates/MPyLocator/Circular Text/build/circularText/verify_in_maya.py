...
BUNDLE = os.path.join(os.path.dirname(__file__), 'circularText.mll')
NODE_TYPE = 'circularText'
SOURCE = 'circularText'
INPUTS = {"displayText": "string", "radius": "float", "letterHeight": "float", "tracking": "float", "tilt": "float", "roll": "float", "aimAxis": "enum", "invertAim": "enum", "upAxis": "enum", "invertUp": "enum", "textStyle": "enum", "ringStyle": "enum", "color": "color", "alpha": "float"}
OUTPUTS = {}
TOL = 1e-4
