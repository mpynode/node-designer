MPyNode compiled plugin: MPyNurbsSurface_NURBS_Ripple
=====================================================
...
What you'll see
---------------
  ../MPyNurbsSurface_NURBS_Ripple.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/rippleSurf.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyNurbsSurface_NURBS_Ripple.bundle
