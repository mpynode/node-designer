#!/usr/bin/env bash
# Generated build for native node 'rippleSurf'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/rippleSurf.bundle" "$HERE/rippleSurf.cpp"
echo "Built: $HERE/rippleSurf.bundle"
lipo -info "$HERE/rippleSurf.bundle"
