MPyNode compiled plugin: MPyBlendShape_Combo_Correctives
========================================================
...
What you'll see
---------------
  ../MPyBlendShape_Combo_Correctives.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/comboCorrectives.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyBlendShape_Combo_Correctives.bundle
