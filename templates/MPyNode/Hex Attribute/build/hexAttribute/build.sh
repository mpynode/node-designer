#!/usr/bin/env bash
# Generated build for native node 'hexAttribute'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/hexAttribute.bundle" "$HERE/hexAttribute.cpp"
echo "Built: $HERE/hexAttribute.bundle"
lipo -info "$HERE/hexAttribute.bundle"
