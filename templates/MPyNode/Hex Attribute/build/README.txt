MPyNode compiled plugin: MPyNode_Hex_Attribute
==============================================
...
What you'll see
---------------
  ../MPyNode_Hex_Attribute.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/hexAttribute.cpp   <- the node. Edit this file to change the plugin's behaviour.
