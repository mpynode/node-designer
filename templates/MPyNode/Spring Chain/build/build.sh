#!/usr/bin/env bash
# Rebuild native plugin 'MPyNode_Spring_Chain' from its single source 'source/springChain.cpp'.
# Edit source/springChain.cpp, then run ./build.sh to produce MPyNode_Spring_Chain.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyNode_Spring_Chain.bundle" "$HERE/source/springChain.cpp"
echo "Built: $HERE/../MPyNode_Spring_Chain.bundle"
lipo -info "$HERE/../MPyNode_Spring_Chain.bundle"
