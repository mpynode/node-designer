MPyNode compiled plugin: MPyNode_Spring_Chain
=============================================
...
What you'll see
---------------
  ../MPyNode_Spring_Chain.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/springChain.cpp   <- the node. Edit this file to change the plugin's behaviour.
