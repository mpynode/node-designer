#!/usr/bin/env bash
# Generated build for native node 'springChain'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/springChain.bundle" "$HERE/springChain.cpp"
echo "Built: $HERE/springChain.bundle"
lipo -info "$HERE/springChain.bundle"
