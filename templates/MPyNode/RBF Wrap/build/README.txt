MPyNode compiled plugin: MPyNode_RBF_Wrap
=========================================
...
What you'll see
---------------
  ../MPyNode_RBF_Wrap.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/rbfWrap.cpp   <- the node. Edit this file to change the plugin's behaviour.
