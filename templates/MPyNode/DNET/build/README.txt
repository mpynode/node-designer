MPyNode compiled plugin: MPyNode_DNET
=====================================
...
What you'll see
---------------
  ../MPyNode_DNET.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/mPyDnet.cpp   <- the node. Edit this file to change the plugin's behaviour.
