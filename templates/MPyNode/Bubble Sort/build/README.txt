MPyNode compiled plugin: MPyNode_Bubble_Sort
============================================
...
What you'll see
---------------
  ../MPyNode_Bubble_Sort.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/bubbleSort.cpp   <- the node. Edit this file to change the plugin's behaviour.
