#!/usr/bin/env bash
# Generated build for native node 'bubbleSort'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/bubbleSort.bundle" "$HERE/bubbleSort.cpp"
echo "Built: $HERE/bubbleSort.bundle"
lipo -info "$HERE/bubbleSort.bundle"
