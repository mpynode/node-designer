...
What you'll see
---------------
  ../MPyNode_Spline.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/spline.cpp   <- the node. Edit this file to change the plugin's behaviour.
