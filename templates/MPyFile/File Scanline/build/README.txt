MPyNode compiled plugin: MPyFile_File_Scanline
==============================================
...
What you'll see
---------------
  ../MPyFile_File_Scanline.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/scanlineTex.cpp   <- the node. Edit this file to change the plugin's behaviour.
