#!/usr/bin/env bash
# Generated build for native node 'fileTexture'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/fileTexture.bundle" "$HERE/fileTexture.cpp"
echo "Built: $HERE/fileTexture.bundle"
lipo -info "$HERE/fileTexture.bundle"
