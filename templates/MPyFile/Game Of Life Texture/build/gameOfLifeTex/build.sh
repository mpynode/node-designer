#!/usr/bin/env bash
# Generated build for native node 'gameOfLifeTex'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/gameOfLifeTex.bundle" "$HERE/gameOfLifeTex.cpp"
echo "Built: $HERE/gameOfLifeTex.bundle"
lipo -info "$HERE/gameOfLifeTex.bundle"
