MPyNode compiled plugin: MPyFile_Game_Of_Life_Texture
=====================================================
...
What you'll see
---------------
  ../MPyFile_Game_Of_Life_Texture.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/gameOfLifeTex.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyFile_Game_Of_Life_Texture.bundle
