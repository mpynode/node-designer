MPyNode compiled plugin: basics_MPyFile_File_Brightness_Contrast
================================================================
...
What you'll see
---------------
  ../basics_MPyFile_File_Brightness_Contrast.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/brightContrastTex.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../basics_MPyFile_File_Brightness_Contrast.bundle
