...
def _geo_build_lines(kind, info):
    ...
    if kind == "mesh":
        L += [
            "    MPointArray _pa;",
            "    for (size_t i = 0; i < points.size(); ++i) _pa.append(points[i]);",
            "    MIntArray _pc;",
            "    for (size_t i = 0; i < counts.size(); ++i) _pc.append(counts[i]);",
            "    MIntArray _ic;",
            "    for (size_t i = 0; i < indices.size(); ++i) _ic.append(indices[i]);",
        ...
        L += [
            "    MPointArray _cv;",
            "    for (size_t i = 0; i < cvs.size(); ++i) _cv.append(cvs[i]);",
            ...
            "            for (size_t i = 0; i < knots.size(); ++i) _knots.append(knots[i]);",
            "        } else if (periodic) {",
