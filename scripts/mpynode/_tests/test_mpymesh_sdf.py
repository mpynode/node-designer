...
_REF_NPZ = os.path.join(
    os.path.dirname(__file__), "test_assets", "test_sdf.igloo.npz"
)
...
_EXAMPLE_MA = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "test_assets", "mPyMesh_sdf_dmc.ma")
