        ...
        **RETURNS**			None
        ...
        if src_dict:
            if type(src_dict) == dict:
                ...
                raise TypeError("src_dict must be dict or OrderedDict. Type " + str(type(src_dict)) + " given")
    ...
    def _convertToOrdered(self, ini_data):
        ...
        for sect in ini_data.keys():
            ...
            if type(ini_data[sect]) == dict:
                ...
                raise TypeError("Section data must be type dict or OrderedDict. Type " + str(type(ini_data)) + " found.")
    ...
    def write(self, out_path, sect_spaces=True, opt_spaces=True):
        ...
        for section in self._data.keys():
            ...
            for option in options.keys():
                ...
                if (not self._str_vals) and (type(value) is str):
    ...
    def __setitem__(self, key, value):
        ...
        if type(value) != OrderedDict:
            ...
            if type(value) == dict:
                ...
                raise TypeError("Sections values must be type dict or OrderedDict. Type " + str(type(value)) + " given.")
