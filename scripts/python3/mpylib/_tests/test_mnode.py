...
from .._base import MNode, MNodeList
...
class TestMNode(unittest.TestCase):
    ...
    def testGetInheritedNodeTypes(self):
        ...
        for node, node_types in zip_longest((self._dag_node, self._dg_node), (self.DAG_INHERITED_TYPES, self.DG_INHERITED_TYPES)):
            ...
            if node:
                ...
                for result_type, node_type in zip_longest( result, node_types):
    ...
    def testBakeResults(self):
        ...
        for node, attr in zip_longest((self._dag_node, self._dg_node), (self.DAG_GET_ATTR, self.DG_GET_ATTR)):
    ...
    def testListAttr(self):
        ...
        for node in (self._dag_node, self._dg_node):
            ...
            if node:
                ...
                for attr_a, attr_b in zip_longest( all_attrs, mc_attrs):
    ...
    def testGetObjectType(self):
        ...
        for node, node_type in zip_longest( (self._dag_node, self._dg_node), (self.DAG_NODE_TYPE, self.DG_NODE_TYPE)):
    ...
    def testRename(self):
        ...
        for node, basename in zip_longest( (self._dag_node, self._dg_node), (self.DAG_NODE_NAME, self.DG_NODE_NAME)):
