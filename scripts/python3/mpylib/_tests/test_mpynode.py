...
class TestMPyNode(unittest.TestCase):
    ...
    def testListStoredVariables(self):
        ...
        for var_name, letter in zip_longest( stored_vars, string.ascii_lowercase):
    ...
    def testSetStoredVariable(self):
        ...
        for i, var_name in enumerate(string.ascii_lowercase):
            ...
            node.setStoredVariable(var_name, {var_name:{str(var_name):1}})
    ...
    def testGetStoredVariables(self):
        ...
        for i, var_name in enumerate(string.ascii_lowercase):
            ...
            self.assertEqual(var_map[var_name][var_name], {str(var_name):1})
