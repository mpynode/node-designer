#!/usr/bin/env bash
# Generated build for native node 'compositeTexture'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/compositeTexture.bundle" "$HERE/compositeTexture.cpp"
echo "Built: $HERE/compositeTexture.bundle"
lipo -info "$HERE/compositeTexture.bundle"
