MPyNode compiled plugin: MPyFile_File_Composite
===============================================
...
What you'll see
---------------
  ../MPyFile_File_Composite.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/compositeTexture.cpp   <- the node. Edit this file to change the plugin's behaviour.
