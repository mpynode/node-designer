#!/usr/bin/env bash
# Generated build for native node 'scanlineTex'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/scanlineTex.bundle" "$HERE/scanlineTex.cpp"
echo "Built: $HERE/scanlineTex.bundle"
lipo -info "$HERE/scanlineTex.bundle"
