...
BUNDLE = os.path.join(os.path.dirname(__file__), 'brightContrastTex.bundle')
NODE_TYPE = 'brightContrastTex'
SOURCE = 'brightContrastTex'
INPUTS = {"brightness": "float", "contrast": "float", "fileName": "string", "uvCoord": "float2"}
