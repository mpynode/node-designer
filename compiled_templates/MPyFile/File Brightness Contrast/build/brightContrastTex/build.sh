#!/usr/bin/env bash
# Generated build for native node 'brightContrastTex'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -lOpenMaya -lFoundation -lOpenMayaRender \
  -o "$HERE/brightContrastTex.bundle" "$HERE/brightContrastTex.cpp"
echo "Built: $HERE/brightContrastTex.bundle"
lipo -info "$HERE/brightContrastTex.bundle"
