MPyNode compiled plugin: MPyFile_File_Simple
============================================
...
What you'll see
---------------
  ../MPyFile_File_Simple.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/fileTexture.cpp   <- the node. Edit this file to change the plugin's behaviour.
