MPyNode compiled plugin: MPyLocator_Mesh_Regions
================================================
...
What you'll see
---------------
  ../MPyLocator_Mesh_Regions.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/meshRegionLocator.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyLocator_Mesh_Regions.bundle
