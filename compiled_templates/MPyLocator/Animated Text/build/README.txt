MPyNode compiled plugin: MPyLocator_Animated_Text
=================================================
...
What you'll see
---------------
  ../MPyLocator_Animated_Text.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/animatedText.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyLocator_Animated_Text.bundle
