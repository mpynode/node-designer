#!/usr/bin/env bash
# Generated build for native node 'animatedText'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/animatedText.bundle" "$HERE/animatedText.cpp"
echo "Built: $HERE/animatedText.bundle"
lipo -info "$HERE/animatedText.bundle"
