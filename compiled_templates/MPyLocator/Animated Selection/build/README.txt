MPyNode compiled plugin: MPyLocator_Animated_Selection
======================================================
...
What you'll see
---------------
  ../MPyLocator_Animated_Selection.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/animatedSelection.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyLocator_Animated_Selection.bundle
