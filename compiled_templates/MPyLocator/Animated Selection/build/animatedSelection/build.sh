#!/usr/bin/env bash
# Generated build for native node 'animatedSelection'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/animatedSelection.bundle" "$HERE/animatedSelection.cpp"
echo "Built: $HERE/animatedSelection.bundle"
lipo -info "$HERE/animatedSelection.bundle"
