...
BUNDLE = os.path.join(os.path.dirname(__file__), 'bubbleSort.bundle')
NODE_TYPE = 'bubbleSort'
SOURCE = 'bubbleSort'
INPUTS = {"maxVal": "float", "minVal": "float", "reset": "enum", "time": "time"}
OUTPUTS = {"sort": "float", "text": "string"}
TOL = 1e-4
