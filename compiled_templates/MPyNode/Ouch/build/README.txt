MPyNode compiled plugin: MPyNode_Ouch
=====================================
...
What you'll see
---------------
  ../MPyNode_Ouch.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/ouch.cpp   <- the node. Edit this file to change the plugin's behaviour.
