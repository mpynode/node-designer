...
BUNDLE = os.path.join(os.path.dirname(__file__), 'springChain.bundle')
NODE_TYPE = 'springChain'
SOURCE = 'springChain'
INPUTS = {"damping": "float", "driver": "vector", "gravity": "vector", "mass": "float", "maxDistance": "float", "minDistance": "float", "resetBuffer": "enum", "tension": "float", "time": "time"}
OUTPUTS = {"driven": "vector"}
TOL = 1e-4
