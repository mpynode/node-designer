MPyNode compiled plugin: MPyNode_Spine
======================================
...
What you'll see
---------------
  ../MPyNode_Spine.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/spine.cpp   <- the node. Edit this file to change the plugin's behaviour.
