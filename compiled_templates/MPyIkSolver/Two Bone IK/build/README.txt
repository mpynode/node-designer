MPyNode compiled plugin: MPyIkSolver_Two_Bone_IK
================================================
...
What you'll see
---------------
  ../MPyIkSolver_Two_Bone_IK.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/twoBoneIK.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyIkSolver_Two_Bone_IK.bundle
