#!/usr/bin/env bash
# Generated build for native node 'helixCurve'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/helixCurve.bundle" "$HERE/helixCurve.cpp"
echo "Built: $HERE/helixCurve.bundle"
lipo -info "$HERE/helixCurve.bundle"
