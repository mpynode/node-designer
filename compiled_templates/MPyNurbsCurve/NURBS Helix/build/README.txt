MPyNode compiled plugin: MPyNurbsCurve_NURBS_Helix
==================================================
...
What you'll see
---------------
  ../MPyNurbsCurve_NURBS_Helix.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/helixCurve.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyNurbsCurve_NURBS_Helix.bundle
