MPyNode compiled plugin: MPyMesh_Voxelize
=========================================
...
What you'll see
---------------
  ../MPyMesh_Voxelize.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/voxelizeMesh.cpp   <- the node. Edit this file to change the plugin's behaviour.
