#!/usr/bin/env bash
# Generated build for native node 'diskMeshCache'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/diskMeshCache.bundle" "$HERE/diskMeshCache.cpp"
echo "Built: $HERE/diskMeshCache.bundle"
lipo -info "$HERE/diskMeshCache.bundle"
