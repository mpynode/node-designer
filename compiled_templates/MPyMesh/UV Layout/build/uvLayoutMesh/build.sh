#!/usr/bin/env bash
# Generated build for native node 'uvLayoutMesh'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/uvLayoutMesh.bundle" "$HERE/uvLayoutMesh.cpp"
echo "Built: $HERE/uvLayoutMesh.bundle"
lipo -info "$HERE/uvLayoutMesh.bundle"
