MPyNode compiled plugin: MPyMesh_Metaballs
==========================================
...
What you'll see
---------------
  ../MPyMesh_Metaballs.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/metaballs.cpp   <- the node. Edit this file to change the plugin's behaviour.
