#!/usr/bin/env bash
# Rebuild native plugin 'MPyMesh_Game_Of_Life' from its single source 'source/gameOfLifeMesh.cpp'.
# Edit source/gameOfLifeMesh.cpp, then run ./build.sh to produce MPyMesh_Game_Of_Life.bundle (one level up).
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/../MPyMesh_Game_Of_Life.bundle" "$HERE/source/gameOfLifeMesh.cpp"
echo "Built: $HERE/../MPyMesh_Game_Of_Life.bundle"
lipo -info "$HERE/../MPyMesh_Game_Of_Life.bundle"
