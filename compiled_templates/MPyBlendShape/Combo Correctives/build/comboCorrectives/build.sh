#!/usr/bin/env bash
# Generated build for native node 'comboCorrectives'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/comboCorrectives.bundle" "$HERE/comboCorrectives.cpp"
echo "Built: $HERE/comboCorrectives.bundle"
lipo -info "$HERE/comboCorrectives.bundle"
