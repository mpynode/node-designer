#!/usr/bin/env bash
# Generated build for native node 'rbfWrapDeformer'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/rbfWrapDeformer.bundle" "$HERE/rbfWrapDeformer.cpp"
echo "Built: $HERE/rbfWrapDeformer.bundle"
lipo -info "$HERE/rbfWrapDeformer.bundle"
