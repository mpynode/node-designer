#!/usr/bin/env bash
# Generated build for native node 'sineRipple'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/sineRipple.bundle" "$HERE/sineRipple.cpp"
echo "Built: $HERE/sineRipple.bundle"
lipo -info "$HERE/sineRipple.bundle"
