MPyNode compiled plugin: MPyDeformer_Sine_Ripple
================================================
...
What you'll see
---------------
  ../MPyDeformer_Sine_Ripple.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/sineRipple.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPyDeformer_Sine_Ripple.bundle
