MPyNode compiled plugin: MPyDeformer_NURBS_Wave
===============================================
...
What you'll see
---------------
  ../MPyDeformer_NURBS_Wave.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/nurbsWave.cpp   <- the node. Edit this file to change the plugin's behaviour.
