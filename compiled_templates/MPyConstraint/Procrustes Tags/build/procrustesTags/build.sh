#!/usr/bin/env bash
# Generated build for native node 'procrustesTags'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/procrustesTags.bundle" "$HERE/procrustesTags.cpp"
echo "Built: $HERE/procrustesTags.bundle"
lipo -info "$HERE/procrustesTags.bundle"
