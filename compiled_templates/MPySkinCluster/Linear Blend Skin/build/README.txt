MPyNode compiled plugin: MPySkinCluster_Linear_Blend_Skin
=========================================================
...
What you'll see
---------------
  ../MPySkinCluster_Linear_Blend_Skin.bundle   <- the plugin you load into Maya (one level up).
...
Source (in source/)
-------------------
  source/linearBlendSkin.cpp   <- the node. Edit this file to change the plugin's behaviour.
...
(one level up from here) as:
  ../MPySkinCluster_Linear_Blend_Skin.bundle
