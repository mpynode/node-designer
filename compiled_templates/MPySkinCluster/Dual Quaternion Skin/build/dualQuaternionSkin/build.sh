#!/usr/bin/env bash
# Generated build for native node 'dualQuaternionSkin'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/dualQuaternionSkin.bundle" "$HERE/dualQuaternionSkin.cpp"
echo "Built: $HERE/dualQuaternionSkin.bundle"
lipo -info "$HERE/dualQuaternionSkin.bundle"
