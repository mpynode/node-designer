#!/usr/bin/env bash
# Generated build for native node 'twistSwingSkin'.
#
...
clang++ -std=c++17 -O3 -ffp-contract=off -arch arm64 -bundle \
  ...
  -o "$HERE/twistSwingSkin.bundle" "$HERE/twistSwingSkin.cpp"
echo "Built: $HERE/twistSwingSkin.bundle"
lipo -info "$HERE/twistSwingSkin.bundle"
