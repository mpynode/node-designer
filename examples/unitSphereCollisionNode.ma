...
//Last modified: Wed, Nov 14, 2018 08:13:43 AM
//Codeset: 1252
...
createNode transform -shared -name "persp";
	...
	setAttr ".translate" -type "double3" 19.684209675566056 19.397154363212714 52.640085108527657 ;
	setAttr ".rotate" -type "double3" -25.538352728260541 376.5999999998067 8.2971923186602261e-16 ;
createNode camera -shared -name "perspShape" -parent "persp";
	rename -uuid "6162AD9A-43D2-62DA-BD77-288C9D05283A";
	setAttr -keyable off ".visibility" no;
	setAttr ".focalLength" 34.999999999999993;
	setAttr ".centerOfInterest" 51.24184671432657;
...
createNode lightLinker -shared -name "lightLinker1";
	rename -uuid "02ED4903-4C32-CF3C-889B-19B142CBEAA2";
	setAttr -size 2 ".link";
	setAttr -size 2 ".shadowLink";
createNode shapeEditorManager -name "shapeEditorManager";
	rename -uuid "A2BA433B-4721-73CA-4466-A283878FAF20";
createNode poseInterpolatorManager -name "poseInterpolatorManager";
	rename -uuid "E1B9A88B-4ED2-80BC-A100-5595AEF89A04";
createNode displayLayerManager -name "layerManager";
	rename -uuid "909CC0E0-4685-3697-7183-71B824D6CE10";
createNode displayLayer -name "defaultLayer";
	rename -uuid "48CE2B42-4A24-18AA-579C-D9A790EF60C4";
createNode renderLayerManager -name "renderLayerManager";
	rename -uuid "780F3870-4517-952B-3688-05B46E6C96DA";
...
createNode mPyNode -name "unitSphereCollisionNode";
	...
	setAttr "._storedVarsData" -type "string" (
		"\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "\n"
		+ "AAAAAAAAAEcAAAAAAAAAAEcAAAAAAAAAAEc/8AAAAAAAAHRScfVoBChHAAAAAAAAAABHAAAAAAAA\nAABHAAAAAAAAAABHP/AAAAAAAAB0UnH2ZXMu\n");
	setAttr -keyable on ".gridX" 17;
	setAttr -keyable on ".gridZ" 13;
	setAttr -size 242 ".result";
	setAttr -keyable on ".pusher";
createNode script -name "uiConfigurationScriptNode";
	rename -uuid "5F3E93ED-4289-F337-6718-749CA3FEBC92";
